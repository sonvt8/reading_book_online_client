...
const routes: Routes = [
  ...
  { 
    ...
    children:[
      ...
      { path: 'chuong_cua_truyen/:sid', component: ChapterComponent, data: {title: 'Xem danh sách chương', roles: ['ROLE_ADMIN', 'ROLE_SMOD', 'ROLE_CONVERTER']}, canActivate: [AuthenticationGuard, RoleGuard]},
      { path: 'sua_chuong_truyen/:sid/:cid', component: ChapterEditComponent, data: {title: 'Sửa chương truyện', roles: ['ROLE_ADMIN', 'ROLE_SMOD', 'ROLE_CONVERTER']}, canActivate: [AuthenticationGuard, RoleGuard]},
    ]
  },
  {
    path: 'quan-tri',
